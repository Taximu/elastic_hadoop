...
env.roledefs = {
    ...
    'master':      ['maxim@stream8'],
    'slaves':      ['maxim@stream2', 'maxim@stream4']
}

experiments = {
     'expm1':     ['maxim@stream2', 'maxim@stream4', 'maxim@stream8']
}
